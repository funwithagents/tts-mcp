...
| 03 — Audio Player | [03-audio-player.md](03-audio-player.md) | sounddevice integration notes | yes |
...
| 08 — E2E Testing | [08-e2e-testing.md](08-e2e-testing.md) | Subprocess server, speak tool call, assertions | yes |
